...
public class NewInvoiceFrame extends JFrame
{
	...
	private static String invoiceNumber = "";					// get in this frame
	private static Date purchaseDate = new Date(); 	// get today's date
	private static double amount = 0.0;							// sum up Articles's subTolals
	public static Stack<Article> purchasedArticles = 
			new Stack<Article>();	// data sent from NewPurchaseFrame
	...
	{		
	    ...
	    // create a label and show invoice number if it exists
	    String str1 = "Invoice Number : ";
	 ...
	 // ------------------------- create a table ----------------------------
    	...
    	else	// prepare a TableModel for table creation
    	{
		    ...
		    {
		    	record = purchasedArticles.pop();	// pop a record
