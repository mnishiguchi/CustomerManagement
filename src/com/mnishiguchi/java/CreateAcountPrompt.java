...
public class CreateAcountPrompt  extends JFrame
{
	// instance variables
	...
	{		
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			{	
				...
				{
					JOptionPane.showMessageDialog(	CreateAcountPrompt.this, 
				...
				else
				{
					...
					if ( Search.exists(customer) )
					{
						...
						CreateAcountPrompt.this.dispose();    // close this frame	
					}
					else
					{
